...
insert(index, "Mercury is the first planet from the sun. It is a rocky planet.", "mercury")
insert(index, "Venus is the second planet from the sun.  It is a rocky planet.", "venus")
insert(index, "Earth is the third planet from the sun.  It is a rocky planet.", "earth")
insert(index, "Mars is the fourth planet from the sun.  It is a rocky planet.", "mars")
